...
& ./tosca_execution_client.ps1 -toscaServerUrl "http://localhost:85" -events '["The 16th"]' -projectName "DEX_Workspace" -resultsFolderPath "./results" -resultsFileName  "Bernhard.xml"
